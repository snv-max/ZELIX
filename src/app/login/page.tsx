      ...
      <div className="max-w-md w-full border border-border bg-card p-8 sm:p-10 rounded shadow-xl space-y-6">
        ...
        <div className="space-y-4 pt-4">
          ...
          >
            ...
            {submitting ? 'Redirecting to Auth0...' : 'Continue with Auth0'}
          </button>
        </div>

        <p className="text-center text-[10px] text-muted-foreground uppercase tracking-wider font-mono pt-4 leading-relaxed">
