      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 sm:gap-8">
          ...
          <div className="md:col-span-1 flex flex-col justify-start">
            <span className="text-2xl font-black tracking-widest text-white mb-6">
              ZELIX
            </span>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3.5 text-sm">
              ...
              <li>
                <Link href="/products?category=tshirt" className="text-muted-foreground hover:text-white transition-colors">
                  T-Shirts
                </Link>
              </li>
              <li>
                <Link href="/products?category=track" className="text-muted-foreground hover:text-white transition-colors">
                  Track & Outerwear
                </Link>
              </li>
              <li>
                <Link href="/products?category=pants" className="text-muted-foreground hover:text-white transition-colors">
                  Pants
                </Link>
              </li>
              <li>
                <Link href="/products?category=accessories" className="text-muted-foreground hover:text-white transition-colors">
                  Accessories
                </Link>
              </li>
            </ul>
